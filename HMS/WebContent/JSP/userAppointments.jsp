...
<!-- navbar -->  
	<nav class="navbar navbar-expand-lg fixed-top ">  
		<a class="navbar-brand" href="new.html"></a>
		...
		<div class="collapse navbar-collapse " id="navbarSupportedContent">
			<ul class="navbar-nav mr-4">
				...
				<li class="nav-item"> 
				 <a class="nav-link " data-value="contact" href="logout.jsp">Sign Out</a>
				</li> 
			</ul> 
		</div>
	</nav>
...
<div class="table">
	<h1>Give rating for your appointment:</h1>
...
<textarea rows="10" cols="70" form="feedbackForm" name="textFeedback">
Give Feedback. 
</textarea>
