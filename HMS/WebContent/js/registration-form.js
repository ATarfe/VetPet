    ...
    render() {
        var element =  (
            <form ref={this.registrationFormRef} className="md-form" method="POST" action="registrationUpdate.jsp">
                <input id="accountTypeInput" type="hidden" value={this.props.accountType} />
                ...
                <div className="form-group">
                    <select className="form-control selectpicker" id="petInput">
                        <option>Dog</option>
                        <option>Cat</option>
                    </select>
                </div>
                ...
                <div className="form-group"> 
                    <input type="text" className="form-control" id="specialisationInput" />
		    ...
		    <input className="btn btn-primary" style={{'width':'100%'}} type="submit" value="submit" />
            </form>
        );
        return element;
    }
